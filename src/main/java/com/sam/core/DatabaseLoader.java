...
import com.sam.course.CourseRepository;
import com.sam.review.Review;
import com.sam.user.User;
import com.sam.user.UserRepository;
...
public class DatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        course.addReview(new Review(3,"You are a bc!!!"));
        courses.save(course);
        String[] templates= {
        ...
        users.save(new User("SnigdhoRahman","Snigdho","Rahman","107611",new String[]{"ROLE_USER", "ROLE_ADMIN"}));
